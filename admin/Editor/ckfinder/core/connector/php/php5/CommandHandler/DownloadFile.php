...
/**
 * Handle Down$funcObj -> LoadFile command
 *
 * @package CKFinder
 * @subpackage CommandHandlers
 * @copyright CKSource - Frederico Knabben
 */
class CKFinder_Connector_CommandHandler_Down$funcObj -> LoadFile extends CKFinder_Connector_CommandHandler_CommandHandlerBase
{
    /**
     * Command name
     *
     ...
     * @var string
     */
    private $command = "Down$funcObj -> LoadFile";
