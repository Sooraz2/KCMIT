...
function ImageResize($image,$destination,$width = 90,$height = 60)
{
...
// Output
    ...
    return  imagejpeg($image_p, $destination);
}

function ImageResizerAnother($src,$dest,$newwidth,$newheight)
{
    ...
    imagejpeg($thumb, $dest); //save image as jpg
