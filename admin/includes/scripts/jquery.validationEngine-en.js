    ...
    $.validationEngineLanguage = {
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                ...
                "number6Decimals4": {
                    "regex": /^-?\d{6}\.(\d{4})?$/,
                    "alertText": "* Maximum 6 character before & 4 character after decimal allowed, Format (XXXXXX.XXXX)"
                },
                "password": {
                ...
                "ajaxCheckSlug": {
                    "url": "HealthNews/CheckSlug",
                    // you may want to pass extra data on the ajax call
                    "extraDataDynamic": [{'ParameterName': 'ID', 'ParameterValue': "#ID"}],
                    "extraDataDynamic": [{'ParameterName': 'ContentType', 'ParameterValue': "#ContentType"}],
                    "extraDataDynamic": [{'ParameterName': 'ContentID', 'ParameterValue': "#ID"}],

                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertText": "* This Slug is already taken",
                    "alertTextLoad": "* Validating, please wait",
                    "alertTextOk": "* Slug Available"
                },
