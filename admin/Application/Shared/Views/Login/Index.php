...
<head>
    ...
    <title><?php use Infrastructure\CookieVariable;
        ...
        echo  $Language->translate("KCMIT")?> : Login</title>
...
<div class="loginwrapper">
    ...
    <div class="loginwrap zindex100 animate2 bounceInDown">
        <h1 class="logintitle"><span class="iconfa-lock"></span> <?php echo  $Language->translate("Sign In") ?> <span class="subtitle">KCMIT</span>
        </h1>
