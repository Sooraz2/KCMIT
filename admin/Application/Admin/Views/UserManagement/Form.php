...
<form action="" method="post" class="form-horizontal" id="UserManagementForm">
    ...
    <div class="form-group">
        <div class="col-xs-6">
            <label class="control-label"><?php echo $Language->translate("Send E-mail notifications")?></label>
        </div>
        <div class="col-xs-6">
            <input type="checkbox" id="SendNotification" name="SendNotification" value="1" <?php  if($loginUser->SendNotification==1): ?>checked="checked" <?php endif ?>  class="">
        </div>
    </div>

    <div class="form-group">
        <div class="col-xs-12 dialog-button">
