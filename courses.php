...
<html lang="zxx">
    <head>
        ...
        <link id="switch_style" href="courses-details2.html" rel="stylesheet" type="text/css">
        <!-- responsive css -->
    ...
    <body class="inner-page">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <ul class="course-meta-style">
                                    <li class="author">
                                        <div class="image">
                                            <img src="images\teachers\2.jpg" width="60"  alt="">
                                        </div>
                                    ...
                                    <div class="tab-content card"> 
                                      ...
                                      <div class="tab-pane fade" id="instructors" role="tabpanel">
                                          <div class="instructor-list">
                                                <div class="image">
                                                    <img src="images\teachers\2.jpg" width="150"  alt="">
                                                </div>
                                                <div class="author-name">
                                          ...
                                          <div class="instructor-list pt-45">
                                                <div class="image">
                                                    <img src="images\teachers\9.jpg" width="150"  alt="">
                                                </div>
                                                <div class="author-name">
                                          ...
                                          <div class="instructor-list pt-45">
                                                <div class="image">
                                                    <img src="images\teachers\6.jpg" width="150"  alt="">
                                                </div>
                                                <div class="author-name">
                                      ...
                                      <div class="tab-pane fade" id="review" role="tabpanel">
                                            ...
                                            <div class="instructor-list">
                                                <div class="image">
                                                    <img src="images\teachers\8.jpg" width="150"  alt="">
                                                </div>
                                                <div class="author-name">
                                                    <div class="client-rating">
                                                        <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> 
                                            ...
                                            <div class="instructor-list mt-15">
                                                <div class="image">
                                                    <img src="images\teachers\7.jpg" width="150"  alt="">
                                                </div>
                                                <div class="author-name">
                                                    <div class="client-rating">
                                                        <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> 
                                            ...
                                            <div class="instructor-list mt-15">
                                                <div class="image">
                                                    <img src="images\teachers\4.jpg" width="150"  alt="">
                                                </div>
                                                <div class="author-name">
                                                    <div class="client-rating">
                                                        <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> <i class="fa fa-star" aria-hidden="true"></i> 
        ...
        <script>
            ...
            $('.menu-teacher').addClass('current-menu-item current_page_item');
        </script>
    </body>
</html>